...
const CurrentlyEnrolledAutoPay = ({ open }) => {
      ...
      <Slide direction="up" in={isOpen} mountOnEnter unmountOnExit>
        <Drawer
          ...
          PaperProps={{
            ...
            ['data-testid']: 'SubmitPaymentEnrolledInAutoPay',
          }}
        >
          <DialogContent>
            ...
            <Box className={classes.confirmTitleContainer}>
              <Typography className={classes.confirmTitle} color={'textPrimary'} variant={'body2'}>
                {t('content.You are currently enrolled in AutoPay') + '.'}
              </Typography>
            </Box>
            <Box>
              <Typography
                ...
                variant={'body2'}
              >
                {t('content.Payments submitted now will be in addition to this scheduled payment')}.
              </Typography>
            </Box>
          </DialogContent>
...
export default CurrentlyEnrolledAutoPay;
